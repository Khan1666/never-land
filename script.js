...
document.querySelector("#page h4").textContent.split("").forEach(function(minnu){
  flutter += `<span>${minnu}</span>`
  document.querySelector("#page h4").innerHTML = flutter;
})
...
var screen = document.querySelector("#nav-page");
